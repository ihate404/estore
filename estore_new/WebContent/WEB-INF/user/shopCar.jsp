		...
		<div class="row" style="height: 150px">
			<div style="float: left" class="line">
				...
				<div style="margin-left: 80px;">
					<img src="${item.book.imgPath }" style="float: left">
					<span>${item.book.name }</span>
				</div>
			</div>
			<div style="float: right" class="row_right">
				<div style="margin-right: 10px">￥${item.book.price }元</div><!-- 单价 -->
				<div>
					<span class="jian">-</span>
					<span><input type="text" class="val" value="${item.num }" style="text-align: center"></span>
					<span class="sum">+</span>
				</div>
				<div class="price">￥${item.cost }元</div><!-- 小结 -->
				<div>
					<a href="">删除</a>
				</div>
			</div>
